            ...
            <div className="relative ml-4">
              <div className="flex flex-col items-center justify-center h-12 w-12">
                <div className="relative group -mb-1">
                  <a href="https://linkedin.com/company/nani-recruitment" target="_blank" className="text-white hover:text-crimson transition-colors duration-300">
          ...
          <div className="pt-2 border-t border-gray-200">
            <div className="flex space-x-4">
              <a href="tel:02012345678" className="text-gray-700 hover:text-crimson transition-colors duration-300">
                <i className="fas fa-phone-alt mr-2"></i> 020 1234 5678
              </a>
            </div>
