  ...
  return (
    <section className="py-16 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-3xl font-bold text-white mb-4">Healthcare Staffing Solutions</h2>
          <p className="text-xl text-gray-200 max-w-2xl mx-auto">Specialized healthcare professionals for your facility</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {roles.map((role, index) => (
            ...
            >
              <div className={`w-14 h-14 ${role.bgColor} bg-opacity-10 rounded-full flex items-center justify-center mb-4`}>
                <i className={`${role.icon} ${role.iconColor} text-2xl`}></i>
              </div>
              <h3 className="text-lg font-bold text-[#232d54] mb-2">{role.title}</h3>
