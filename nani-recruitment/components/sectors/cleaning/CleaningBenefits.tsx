        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          >
            <div className="bg-white/90 backdrop-blur-sm p-6 rounded-2xl shadow-lg">
              ...
              >
                "The cleaning staff from NANI Recruitment have been exceptional. They're reliable, thorough, and have made a real difference to our care home environment. Our residents feel comfortable with them, and the infection control measures have been outstanding."
              </motion.p>
