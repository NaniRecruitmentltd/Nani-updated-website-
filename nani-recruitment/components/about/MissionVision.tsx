          ...
          >
            <motion.div variants={{itemVariants}}>
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                We believe that exceptional healthcare staffing isn't just about filling positions—it's about creating meaningful connections that benefit patients, healthcare providers, and the professionals we place.
              </p>
            </motion.div>
            ...
            <motion.div variants={{rightItemVariants}}>
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                We envision a healthcare sector where staffing solutions contribute positively to patient outcomes, professional satisfaction, and organizational success—and we're committed to making that vision a reality.
              </p>
            </motion.div>
          </motion.div>
        </div>
