        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-gray-700 max-w-4xl mx-auto leading-relaxed">
              At NANI Recruitment, candidates don't just get jobs—they get long-term support, resources, and guidance throughout their career journey. We're committed to helping healthcare professionals thrive, both professionally and personally.
            </p>
          </motion.div>
