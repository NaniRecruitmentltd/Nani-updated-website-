        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              We understand that healthcare staffing isn't simply about filling vacancies—it's about finding the right people who will enhance your team's capabilities and contribute positively to patient outcomes. That's why we take the time to understand both our clients' specific needs and our candidates' unique strengths.
            </motion.p>
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              Compliance forms a core pillar of our approach. We strictly adhere to industry standards and regulations, conducting thorough vetting processes to guarantee safe, competent placements every time. When you work with NANI, you can trust that we've done our due diligence—because we believe excellence in healthcare begins with excellence in recruitment.
            </motion.p>
          </motion.div>
        </div>
      </div>
